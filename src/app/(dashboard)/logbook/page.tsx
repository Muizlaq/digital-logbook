...
export default function PersonalLogbookListPage() {
  ...
  // Fetch Logbooks (Paginated or full for calendar)
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h2 className="text-xl font-bold text-slate-900 dark:text-slate-100 tracking-tight flex items-center gap-2">
            <BookOpen className="h-5 w-5 text-blue-600 dark:text-blue-400" /> Log Book Saya
          </h2>
        ...
        <div className="flex items-center gap-2.5">
          ...
          <Button asChild className="bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl text-xs shadow-xs cursor-pointer">
            ...
            <CardContent className="p-4 space-y-3">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
                ...
                <div className="lg:col-span-2 relative">
                  ...
                  <Input
                    ...
                    className="pl-9 text-xs dark:bg-slate-950 dark:border-slate-800"
                  />
                </div>
                ...
                <div>
                  <Button
                    ...
                    className="w-full text-xs text-slate-600 dark:text-slate-300 dark:border-slate-800 hover:text-slate-900 gap-1.5"
                  >
              ...
              <div className="flex flex-wrap items-center gap-3 pt-2 border-t border-slate-100 dark:border-slate-800 text-xs">
                <span className="font-semibold text-slate-600 dark:text-slate-300 flex items-center gap-1.5">
                  <Calendar className="h-3.5 w-3.5 text-blue-600 dark:text-blue-400" /> Rentang Tanggal:
                </span>
                <div className="flex items-center gap-2">
                  <Input
                    ...
                    className="h-8 text-xs w-36 dark:bg-slate-950 dark:border-slate-800"
                  />
              ...
              <Table className="dark:border-slate-800">
                <TableHeader className="dark:bg-slate-950/80">
                  <TableRow className="dark:border-slate-800">
                    ...
                    <TableHead>Aktivitas & Tanggal</TableHead>
                    <TableHead>Kategori & Lokasi</TableHead>
                    <TableHead>Hasil / Capaian Output</TableHead>
                ...
                <TableBody>
                  {items.map((item: any, idx: number) => (
                    <TableRow key={item.id} className="dark:border-slate-800/80 hover:dark:bg-slate-800/40">
                      ...
                      <TableCell>
                        <div className="space-y-1">
                          <Link
                            ...
                            className="font-bold text-slate-900 dark:text-slate-100 hover:text-blue-600 dark:hover:text-blue-400 text-sm line-clamp-1"
                          >
                            {item.title}
                          </Link>
                        ...
                        <div className="space-y-1 text-xs">
                          <div className="font-semibold text-slate-800 dark:text-slate-200 flex items-center gap-1.5">
                            <span
                              ...
                              style={{ backgroundColor: item.category?.colorHex || "#3b82f6" }}
                            />
                      ...
                      <TableCell>
                        <p className="text-xs text-slate-700 dark:text-slate-300 font-medium line-clamp-2 max-w-sm">
                          {item.outputResult}
                        </p>
                      </TableCell>
                      ...
                      <TableCell className="text-right">
                        <div className="flex items-center justify-end gap-1.5">
                          ...
                          <Button
                            ...
                            variant="ghost"
                            size="icon"
                            className="h-8 w-8 text-slate-600 dark:text-slate-300 hover:text-amber-600 dark:hover:text-amber-400"
